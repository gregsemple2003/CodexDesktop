# PROBLEM-0002 OPTION-A: Hard STOP/PAUSE ownership state

## Title

Hard STOP/PAUSE ownership state

## Summary

Treat stop, pause, and no-homework-back boundaries as explicit execution state rather than conversational tone.

## Goals

- Reduce the burden described under PROBLEM-0002 in the April 19 ThirdPerson intervention packet.
...
The human has to restore ownership boundaries, pause state, and approval surfaces that should already have been durable system behavior.

## Causal Claim

The packet suggests this burden persists because add a durable paused/ownership state and tool-use gate that requires explicit resume before work continues.

## Evidence

- Packet evidence ids: hie-20260419-019da198-ea2f-7421-8adc-c566da0b6121-4015, hie-20260419-019da198-ea2f-7421-8adc-c566da0b6121-4379, hie-20260419-019da198-ea2f-7421-8adc-c566da0b6121-5310, hie-20260419-019da19b-19c6-7e20-bdd8-f03aea761fb9-7038
...
Add a durable paused/ownership state and tool-use gate that requires explicit resume before work continues.
