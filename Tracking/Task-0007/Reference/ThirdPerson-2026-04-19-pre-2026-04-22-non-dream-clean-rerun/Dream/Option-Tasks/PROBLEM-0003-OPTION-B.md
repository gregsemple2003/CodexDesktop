# PROBLEM-0003 OPTION-B: Debugging disagreement-seam contract

## Title

Debugging disagreement-seam contract

## Summary

Require named disagreement values and upstream writer tracing before symptom iteration continues.

## Goals

- Reduce the burden described under PROBLEM-0003 in the April 19 ThirdPerson intervention packet.
...
The human has to re-ask direct questions and restate the debugging method instead of receiving answer-first, first-disagreement work by default.

## Causal Claim

The packet suggests this burden persists because extend the debugging artifact/process so the first concrete disagreement, its values, and traced writer chain are mandatory before more tweaks.

## Evidence

- Packet evidence ids: hie-20260419-019da198-ea2f-7421-8adc-c566da0b6121-3392, hie-20260419-019da198-ea2f-7421-8adc-c566da0b6121-5090, hie-20260419-019da198-ea2f-7421-8adc-c566da0b6121-5340, hie-20260419-019da19b-19c6-7e20-bdd8-f03aea761fb9-7446
...
Extend the debugging artifact/process so the first concrete disagreement, its values, and traced writer chain are mandatory before more tweaks.
