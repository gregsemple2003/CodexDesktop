# PROBLEM-0003 OPTION-A: Direct-answer-first response rule

## Title

Direct-answer-first response rule

## Summary

Force yes/no, agree/disagree, and simple factual questions to be answered on line one before any elaboration.
...
The packet suggests this burden persists because add a response-shape gate that extracts explicit questions and blocks forward motion until they are answered directly.
...
Add a response-shape gate that extracts explicit questions and blocks forward motion until they are answered directly.
