...
curl -fsSL https://claude.ai/install.sh | bash Copy command to clipboard irm https://claude.ai/install.ps1 | iex Copy command to clipboard Or read the documentation Try Claude Code Try Claude Code Try Claude Code Developer docs Developer docs Developer docs

## Use Claude Code where you work

Desktop Terminal IDE Web and iOS Slack Active Prompt
...
Download Claude for desktop Download Claude for desktop Download Claude for desktop Prompt
...
curl -fsSL https://claude.ai/install.sh | bash Copy command to clipboard irm https://claude.ai/install.ps1 | iex Copy command to clipboard Or read the documentation Try Claude Code Try Claude Code Try Claude Code Developer docs Developer docs Developer docs Prompt
...
VS Code VS Code VS Code JetBrains JetBrains JetBrains Prompt
...
Open in browser Open in browser Open in browser Prompt
...
Individual Team & Enterprise Active
...
Start building Start building Start building
...
Get Team plan Get Team plan Get Team plan

### Enterprise

Enterprise plan includes everything in the Team plan, plus advanced security, data, and user management. Learn more here .

‍

Get Enterprise plan Get Enterprise plan Get Enterprise plan
...
Pair with your phone Pair with your phone Pair with your phone
...
. This is some text inside of a div block. > Can you look at the open Github issues for the Financial Data Analyst project and fix ones that are relevant?
...
. This is some text inside of a div block. > Refactor the permission request components to share common UI elements and behavior.
...
VS Code VS Code VS Code JetBrains JetBrains JetBrains

### Access anywhere

Quick access from browser, mobile app, or Claude on desktop. Great for parallel work or on-the-go coding.

Open in browser Open in browser Open in browser Download app Download app Download app Kick off coding tasks in Slack Add to Slack Add to Slack Add to Slack Learn more Learn more Learn more

## Latest feature announcements

Redesigned Desktop app: Built to help you run more Claude Code tasks at once. Redesigned Desktop app: Built to help you run more Claude Code tasks at once. Redesigned Desktop app: Built to help you run more Claude Code tasks at once. Blog Blog Blog Apr 14, 2026 Routines: Configure a routine once, and it can run on a schedule, from an API call, or in response to an event Routines: Configure a routine once, and it can run on a schedule, from an API call, or in response to an event Routines: Configure a routine once, and it can run on a schedule, from an API call, or in response to an event Blog Blog Blog Apr 14, 2026 Auto mode: A safer long-running alternative to --dangerously-skip-permissions Auto mode: A safer long-running alternative to --dangerously-skip-permissions Auto mode: A safer long-running alternative to --dangerously-skip-permissions Blog Blog Blog Mar 24, 2026 View changelog View changelog View changelog
...
Anton Biryukov, Staff Software Engineer Read story Read story Read story
...
Fergal Reid, VP of AI Read story Read story Read story
...
Simon Last, Co-founder Read story Read story Read story
...
Prev Prev Next Next Improving frontend design through Skills

Best practices for building richer, more customized frontend design with Claude and Skills.

Read article Read article Read article Prev Prev Next Next

## Get the technical rundown

Claude Code documentation Claude Code documentation Claude Code documentation Developer docs Developer docs Developer docs Common workflows Common workflows Common workflows Developer docs Developer docs Developer docs Using CLAUDE.md files: Customizing Claude Code for your codebase Using CLAUDE.md files: Customizing Claude Code for your codebase Using CLAUDE.md files: Customizing Claude Code for your codebase Blog Blog Blog Introduction to agentic coding

Introduction to agentic coding

Introduction to agentic coding

Blog Blog Blog How Anthropic teams use Claude Code How Anthropic teams use Claude Code How Anthropic teams use Claude Code Case study Case study Case study Fix software bugs faster with Claude Fix software bugs faster with Claude Fix software bugs faster with Claude Blog Blog Blog

## Create what’s exciting. Maintain what’s essential.

Use Claude Code where you work Get Claude Code
...
x.com x.com LinkedIn LinkedIn YouTube YouTube Instagram Instagram English (US) English (US) 日本語 (Japan) Deutsch (Germany) Français (France) 한국어 (South Korea)
